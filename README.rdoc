...
and other devices that front your app.  But sometimes that just isn't
enough.  Sometimes you want to rate limit requests from users based on
application logic that is not practical to get to or replicate in those
services.
